...
<body>
    <div class="email-container">
        ...
        <div class="email-content">
            ...
            <p class="message">
                A new overtime request has been submitted by <strong>{{ $employee->name }}</strong> that requires your review and approval.
            </p>
            ...
            <p class="message">
                Please review this request in accordance with the company's overtime policy and provide your decision at your earliest convenience.
            </p>
