<!-- labor-demand-update.blade.php -->
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Labor Demand Request Updated</title>
    <style>
        body {
...
<body>
    <div class="email-container">
        <div class="email-header">
            <h1>Labor Demand Request Updated</h1>
        </div>
        
        <div class="email-content">
            <p class="greeting">Dear General Manager,</p>
            
            <p class="message">
                Labor demand request with ID: <strong>{{ $demand->recruitment_demand_id }}</strong> has been updated.
            </p>
