        ...
        <div class="col-lg-8">
            <div class="card shadow-sm">
                <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center py-3">
                    <h3 class="card-title m-0 fw-bold">Create E-learning Grade Rule</h3>
                    <a href="{{ route('evaluation.rule.elearning.grade.index') }}" class="btn btn-light">
                        <i class="fas fa-arrow-left me-1"></i> Back to List
                    </a>
                </div>
                <div class="card-body p-4">
                    <form action="{{ route('evaluation.rule.elearning.grade.store') }}" method="POST" id="gradeForm">
                        @csrf
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6">
                                <div class="form-floating mb-3">
                                    <input type="number" class="form-control range-check" id="min_score" name="min_score" min="0" max="100" required value="{{ old('min_score', 0) }}" placeholder="Min Score">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating mb-3">
                                    <input type="number" class="form-control range-check" id="max_score" name="max_score" min="0" max="100" value="{{ old('max_score') }}" placeholder="Max Score">
