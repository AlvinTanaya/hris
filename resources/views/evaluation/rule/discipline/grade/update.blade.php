        ...
        <div class="col-lg-8">
            <div class="card shadow-sm">
                <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center py-3">
                    <h3 class="card-title m-0 fw-bold">Edit Discipline Grade Rule</h3>
                ...
                <div class="card-body p-4">
                    ...
                    <form action="{{ route('evaluation.rule.discipline.grade.update', $grade->id) }}" method="POST" id="gradeForm">
                        @csrf
                        @method('PUT')
