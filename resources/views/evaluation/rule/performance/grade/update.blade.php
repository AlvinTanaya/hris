        ...
        <div class="col-lg-8">
            <div class="card shadow-sm">
                <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center py-3">
                    <h3 class="card-title m-0 fw-bold">Edit Performance Grade Rule</h3>
                    <a href="{{ route('evaluation.rule.performance.grade.index') }}" class="btn btn-light">
                ...
                <div class="card-body p-4">
                    ...
                    <form action="{{ route('evaluation.rule.performance.grade.update', $grade->id) }}" method="POST" id="gradeForm">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6">
                                <div class="form-floating mb-3">
                                    <input type="number" class="form-control range-check" id="min_score" name="min_score" min="0" required value="{{ old('min_score', $grade->min_score) }}" placeholder="Min Score">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating mb-3">
                                    <input type="number" class="form-control range-check" id="max_score" name="max_score" min="0" value="{{ old('max_score', $grade->max_score) }}" placeholder="Max Score">
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            <a href="{{ route('evaluation.rule.performance.grade.index') }}" class="btn btn-outline-secondary">
...
<script>
    $(document).ready(function() {
        ...
        function validateRanges() {
            ...
            $.ajax({
                url: '{{ route("evaluation.rule.performance.grade.check-overlap") }}',
                method: 'POST',
                headers: {
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data.valid) {
                        ...
                        $overlapError.fadeIn();
                        $('html, body').animate({
                            scrollTop: $overlapError.offset().top - 100
                        }, 'slow');
                    }
                },
                error: function(error) {
