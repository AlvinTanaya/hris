...
@section('content')
<a href="{{ route('time.set.shift.index') }}" class="btn btn-danger ms-2 px-5"> <i class="fas fa-arrow-left me-2"></i>Back</a>
...
<div class="container mt-4 mx-auto">
    ...
    <div class="card shadow-lg">
        <div class="card-body">
            <form action="{{ route('time.set.shift.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
