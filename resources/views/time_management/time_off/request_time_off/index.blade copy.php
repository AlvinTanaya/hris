                            ...
                            <table id="approvedTable" class="table table-bordered table-hover w-100">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge bg-success">Approved by {{ $request->dept_approved_by }}</span>
                                            <span class="badge bg-success">Approved by {{ $request->admin_approved_by }}</span>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            ...
                            <table id="declinedTable" class="table table-bordered table-hover w-100">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <p><strong>Declined by:</strong> {{ $request->dept_approved_by }} {{ $request->admin_approved_by }}</p>
                                            <p><strong>Reason:</strong> {{ $request->declined_reason ?? 'No reason provided' }}</p>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
