        ...
        <div class="col-md-8">
            <div class="card shadow-sm">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0">
                        <i class="fas fa-plus-circle"></i> Create New Warning Letter Rule
                    </h5>
                </div>

                <div class="card-body">
                    <form action="{{ route('warning.letter.rule.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="expired_length" name="expired_length" min="1">
