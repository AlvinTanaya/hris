...
<h1 class="text-center text-warning" style="margin-bottom: 65px; margin-top:25px">
    <i class="fas fa-plus"></i> Add Shift Rule
</h1>

<div class="container mt-4 mx-auto">
    <div class="card shadow-lg">
        <div class="card-body">
            <form action="{{ route('time.rule.store') }}" method="POST">
                @csrf
                ...
                <table class="table table-bordered mt-4">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><input type="time" class="form-control" name="start_time[{{ $day }}]"></td>
                            <td><input type="time" class="form-control" name="end_time[{{ $day }}]"></td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
