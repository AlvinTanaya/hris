        ...
        <div class="col-md-8">
            <div class="card shadow-sm">
                <div class="card-header bg-primary text-white">
                    <h5 class="mt-2"><i class="fas fa-edit"></i> Edit Position</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('user.positions.update', $position->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('position') is-invalid @enderror" 
                                   id="position" name="position" value="{{ old('position', $position->position) }}" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('ranking') is-invalid @enderror" 
                                   id="ranking" name="ranking" value="{{ old('ranking', $position->ranking) }}" required>
